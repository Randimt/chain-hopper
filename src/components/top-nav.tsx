      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          {isConnected && address ? (
            <button
              onClick={() => disconnect()}
              className="flex items-center gap-2 h-9 px-3 sm:px-3.5 rounded-lg bg-white/[0.04] border border-white/[0.08] text-zinc-100 hover:bg-white/[0.06] transition-colors text-xs sm:text-sm font-medium"
            >
